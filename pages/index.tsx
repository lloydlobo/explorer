      ...
      <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl sm:py-16 md:grid md:grid-cols-2 lg:px-6 xl:gap-16">
        ...
        <div className="mt-4 md:mt-0">
          ...
          <p className="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
            Join Explorer today and start using our online tool and API to check
            parity prices for countries and access all the details about each
            country.
          </p>
          <a
            href="#"
      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="mb-8 max-w-screen-md lg:mb-16">
          ...
          <p className="text-gray-500 sm:text-xl dark:text-gray-400">
            Determine the correct price to pay in each country, simplifying the
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Collaborate seamlessly with your team to plan, create, and launch
              successful marketing campaigns each month using our marketing
              plan.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">
              ...
              custom permissions designed specifically for your organization and
              devices.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Automate tasks, send notifications, and more with our customizable
              templates that make it easy to get started.
            </p>
          </div>
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full lg:w-12 lg:h-12 bg-primary-100 dark:bg-primary-900">
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Craft beautiful, seamless experiences for marketing and product
              teams with our real cross-company collaboration.
            </p>
          </div>
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full lg:w-12 lg:h-12 bg-primary-100 dark:bg-primary-900">
      ...
      <div className="grid py-8 px-4 mx-auto max-w-screen-xl lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
        <div className="place-self-center mr-auto lg:col-span-7">
          ...
          <p className="mb-6 max-w-2xl font-light text-gray-500 md:text-lg lg:mb-8 lg:text-xl dark:text-gray-400">
            Our simple web app, powered by REST Countries API, lets you compare
            product prices across different countries. Choose the country and
            product you want to compare and we&apos;ll handle the rest.
          </p>
          <a
            href="#"
      ...
      <div className="flex flex-col justify-between items-center p-4 rounded-lg border border-gray-200 shadow-sm sm:flex-row dark:bg-gray-800 dark:border-gray-700 bg-gray-45">
        <div className="flex-shrink-0 w-full sm:flex sm:w-auto">
          <div className="relative flex-shrink-0 mb-4 w-full! sm:mr-4 sm:mb-0 sm:w-64! lg:w-96!">
            ...
            <Search setSearchCount={setSearchCount} />
          </div>
        </div>
